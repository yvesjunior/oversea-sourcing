...
// action, filterable PER ORG and PER USER, range-paginated (the log only
// grows). Writes: src/server/audit.ts. Own nav entry since 2026-08-27
// (moved out of /interne/utilisateurs).
...
function Logging() {
  ...
  }, [orgFilter, actorFilter, fromDate, toDate, page, pageSize]);
